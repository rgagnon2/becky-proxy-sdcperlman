...
const photos = createJsonController('http://ec2-18-237-197-107.us-west-2.compute.amazonaws.com:6001/buildings'); //'http://localhost:6001/api/photos'); //'http://54.151.43.93:6001/api/photos');
